    ...
    <div className="step-content step-path">
      <div className="step-icon">
        <svg width="48" height="48" viewBox="0 0 48 48" fill="none">
          ...
          <path d="M16 18V32C16 33.1 16.9 34 18 34H30C31.1 34 32 33.1 32 32V20C32 18.9 31.1 18 30 18H24L20 14H18C16.9 14 16 14.9 16 16V18Z" stroke="#4F6EF7" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
      ...
      {outputDir && (
        <div className="path-display">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M2 4H5L6.5 6H12V11H2V4Z" stroke="#8B909A" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
